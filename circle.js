class Vehicle{
    ...
    //   this.movingVelocity = this.botz*5*parseInt(scattering_velocity)/5
     ...
     random_walk() {
        ...
        this.movingVelocity = this.botz*parseInt(scattering_velocity)
        ...
        // if (this.position.x < 150*s_x  ) {this.direction.x = 1;}
    ...
    if ((this.position.x > (150)*s_x) && (this.position.x < (250 * s_x+((400)/8*count_pn_num)*s_x))&& V_applied_p>0) {
        ...
        if (this.color == 0) {
            ...
            //x- 150 / 250+50*count_pn_num 
            //y- 100 / 0 

     

            let a = -2/count_pn_num*this.position.x+(100+500/count_pn_num)
            this.acceleration = a;
    ...
    } else if ((this.position.x > (150)*s_x) && (this.position.x < (250 * s_x+((400)/8*count_pn_num)*s_x))&& V_applied_p<0 && this.position.x>270*s_x) {
